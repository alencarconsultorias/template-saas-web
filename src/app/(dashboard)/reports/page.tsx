  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-100">{t("reports.title")}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div className="bg-black rounded-lg p-6">
          <h3 className="text-gray-400 mb-2">{t("reports.stats.totalRevenue")}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-black rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-100 mb-4">{t("reports.charts.revenue")}</h3>
        ...
        <div className="bg-black rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-100 mb-4">{t("reports.charts.users")}</h3>
          <div className="h-64 bg-gray-800 rounded-lg flex items-center justify-center">
