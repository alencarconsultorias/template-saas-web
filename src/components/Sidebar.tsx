  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`fixed bottom-0 left-0 z-40 bg-black transform lg:translate-x-0 lg:static lg:inset-0 ${
          isCollapsed ? 'w-16' : 'w-64'
        } h-[calc(100vh-2rem)] mt-4 mb-2 lg:mt-2 lg:mb-2 rounded-lg`}
      >
        <div className="flex flex-col h-full max-h-full">
          {/* Header - Altura fixa */}
          <div className="flex items-center justify-center h-14 px-4 bg-black border-b border-gray-800 flex-shrink-0 rounded-t-lg">
            {!isCollapsed && (
              <motion.h1 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          <div className="p-3 border-t border-gray-800 flex-shrink-0 rounded-b-lg">
            {!isCollapsed ? (
              <motion.div 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                <div className="w-7 h-7 rounded-full bg-gold-500/20 flex items-center justify-center flex-shrink-0">
                  <UserGroupIcon className="w-3 h-3 text-gold-500" />
                </div>
                <div className="ml-3 min-w-0">
                  <p className="text-xs font-medium text-gray-300 truncate">John Doe</p>
